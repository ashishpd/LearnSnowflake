...
├── 02-snowflake-architecture.md
├── 02-snowflake-architecture-01-virtual-warehouses.md
├── 02-snowflake-architecture-02-data-storage.md
├── 03-data-loading.md
├── 03-data-loading-01-bulk-loading.md
├── 03-data-loading-02-snowpipe.md
├── 04-data-unloading.md
├── 05-data-sharing.md
├── 06-security.md
├── 07-performance-optimization.md
├── 08-sql-and-querying.md
├── 09-advanced-features.md
├── 10-data-governance.md
├── 11-automation.md
├── 12-semi-structured-data.md
